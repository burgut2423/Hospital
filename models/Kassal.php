 ...
 */
class Kassal extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['fish', 'tugsanasi', 'jinsi', 'yashashjoyi', 'tuman', 'shaxar', 'qishloq', 'kucha', 'uy', 'xona', 'telefon', 'doimiyaysh', 'vaqtincha', 'oyishish', 'roysanasi', 'chiqishsababi', 'dispanserbog', 'ayanashumuasasa', 'boshqa', 'tashkilotniomi', 'qonguruxi', 'rezuz'], 'required'],
            [['fish', 'tugsanasi', 'jinsi', 'yashashjoyi', 'tuman', 'shaxar', 'qishloq', 'kucha', 'uy', 'xona', 'telefon', 'doimiyaysh', 'vaqtincha', 'oyishish', 'roysanasi', 'chiqishsababi', 'dispanserbog', 'ayanashumuasasa', 'boshqa', 'tashkilotniomi', 'qonguruxi', 'rezuz'], 'string', 'max' => 100],
        ];
    }
